...
<aside class="h-full w-72 left-0 top-0 fixed bg-surface-container-low border-r border-outline-variant z-50 hidden lg:flex flex-col py-md">
...
<main class="lg:ml-72 min-h-screen flex flex-col pb-24 lg:pb-0">
  <header class="w-full top-0 sticky z-50 flex flex-wrap gap-3 justify-between items-center px-margin-desktop py-3 bg-surface backdrop-blur-md border-b border-outline-variant">
  ...
  <div class="p-margin-desktop flex flex-col gap-lg" data-view-panel="control">
    ...
    <section class="grid grid-cols-1 lg:grid-cols-4 gap-md">
      <div class="lg:col-span-3 h-[620px] rounded-2xl border border-outline-variant overflow-hidden relative isolate">
        <div id="map"></div>
  ...
  <div class="p-margin-desktop hidden" data-view-panel="routing">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-md">
      ...
      <div class="lg:col-span-2 h-[540px] rounded-2xl border border-outline-variant overflow-hidden relative isolate"><div id="rmap" style="height:100%;width:100%"></div></div>
    </div>
  </div>
